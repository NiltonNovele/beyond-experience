...
return (
<> <main className="min-h-screen bg-gray-50 flex justify-center p-4"> <div className="w-full max-w-2xl">
{/* Header */} <div className="flex items-center justify-between mb-6 relative">
<h1 className="text-6xl font-bold text-center w-full" style={{ fontFamily: "MyFont2" }}>Events</h1> </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
        <div className="bg-white rounded-xl w-full max-w-md p-6 relative shadow-xl">
          ...
          <div className="flex items-center text-gray-500 mb-4 text-sm">
            <BsCalendar2Event className="mr-2" /> {selectedEvent.date} {selectedEvent.time && `| ${selectedEvent.time}`}
          </div>
